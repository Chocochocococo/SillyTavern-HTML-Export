...
- 「完整聊天：嘗試套用目前 ST 樣式」會嘗試將當前主題樣式套用至匯出的 HTML 檔案，但若使用特殊的第三方主題，極有可能套用不全。
...
- 在匯出時會將啟用的 Regex 套用一遍再匯出。
- 若有使用翻譯功能，匯出內容也會套用譯文，想匯出原文的話，需要先將聊天訊息變回原文。
- 使用第三方主題與 CSS snippets  時，建議啟用「畫面樣式匯出包含主題擴充 CSS」。
